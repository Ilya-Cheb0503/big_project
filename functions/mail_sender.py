...
async def send_email(subject, body, to_email='rabota@ogk2.ru'):
    '''
    ...
    to_email - email адрес, на который будет направлено уведомелние в виде сообщения (например об отклике или заполненных анкентных данных)
    '''
